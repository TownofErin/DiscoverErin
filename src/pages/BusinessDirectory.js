...
const BusinessCard = ({ place }) => (
  <div className="min-w-[300px] w-full bg-white rounded-lg overflow-hidden shadow-sm">
    {/* Category Icon */}
    ...
    <div className="p-4">
      ...
      <div className="flex items-center space-x-4">
        ...
        <a href={place.google_maps} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 text-sm font-medium">
          Directions
        </a>
      </div>
    </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className={`w-full lg:w-2/5 ${showMap ? 'hidden lg:block' : ''} overflow-y-auto pb-16 lg:pb-0 bg-gray-50`}>
          <div className="p-4">
            ...
            {/* Cards Grid - Fixed columns for each breakpoint */}
        ...
        <div className={`w-full lg:w-3/5 ${!showMap ? 'hidden lg:block' : ''} relative`}>
          <MapComponent businesses={places} />
        </div>
      </div>
